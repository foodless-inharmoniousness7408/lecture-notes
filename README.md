...
3. A Windows security window may appear. Click "More info" and then "Run anyway" if prompted.
4. Follow the instructions on the screen to complete the setup.
5. Create a desktop shortcut when prompted to make opening the app easier.
...
5. Grant the permissions requested by the application. This allows the program to create and edit files on your behalf.
6. Close the browser window and return to the application.
...
3. Select the video or audio file you want to process.
4. Choose the language spoken in the recording from the drop-down menu.
5. Click "Start Process".
6. The software displays a status bar to show the progress. This may take several minutes depending on the length of the recording and the power of your graphics card.
7. Once the process completes, a link appears on the screen. Click this link to open your new Google Doc.
